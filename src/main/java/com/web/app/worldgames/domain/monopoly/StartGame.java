...
public class StartGame {
	static Map<Integer, SellableCard> boardCities = new HashMap<Integer, SellableCard>();
	static Map<Integer, SellableCard> boardRails = new HashMap<Integer, SellableCard>();
