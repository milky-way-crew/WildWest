...
public class ChessGame {
	...
	private ResultEnum battle(Position from, Position to, Figure figure,
			Figure figure2) {
	...
	public ResultEnum resolveDraw() {
		...
		log.info("CHANGED FIGURE TYPE FROM: " + figure.getType() + " TO " + opponent.getDrawChoice() );
		...
		log.info("CHANGED FIGURE TYPE FROM: " + figure.getType() + " TO " + currentPlayer.getDrawChoice() );
