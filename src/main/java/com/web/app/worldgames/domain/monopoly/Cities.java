...
//	GDYNIA("GDYNIA", "brown", 600000, 20000, 30000, 50000, 50, 0,20, 60,180, 50, false,430,CellPositions.GDYNIA), 
//	TAIPEI("TAIPEI", "brown", 600000, 20000, 30000, 50000, 50, 0,30, 80,190, 50, false,450, CellPositions.TAIPEI),
//	TOKYO("TOKYO", "azure",	1000000, 40000, 60000, 90000, 50, 0,30, 90,270, 50, false, 550,CellPositions.TOKYO),
//	BARCELONA("BARCELONA", "azure",1000000, 400000, 600000, 900000, 50,  0,30, 90,270, 50, false,550,CellPositions.BARCELONA), 
//	ATHENS("ATHENS", "azure", 1200000, 500000, 700000, 900000, 70, 0,40, 100,300, 70, false, 600,CellPositions.ATHENS),
//	ISTAMBUL("ISTAMBUL", "violet", 1400000, 500000, 1000000, 150, 100, 0,50, 150,450, 100, false,750,CellPositions.ISTAMBUL),
//	KYIV("KYIV", "violet", 1400000, 500000, 1000000, 1500000, 100, 0,50, 150,450, 100, false, 750,CellPositions.KYIV), 
//	TORONTO("TORONTO","violet",1600000, 600000, 800000, 900000, 100, 0,60, 180,500, 100, false,900,CellPositions.TORONTO),
//	ROME("ROME", "orange",1800000, 900000, 900170, 900190, 100, 0,70, 200,550, 100, false, 950,CellPositions.ROME),
//	SHANGHAI("SHANGHAI","orange",1800000, 900000, 900170, 900190, 100, 0,70, 200,550, 100, false,950,CellPositions.SHANGHAI),
//	VANCOVER("VANCOVER", "orange", 2000000, 900110, 900190, 990210, 100, 0,80, 240,600, 100, false, 1000,CellPositions.VANCOVER),
//	SYDNEY(	"SYDNEY", "red", 2200000, 1500000, 1700000, 2000000, 150, 0,90, 250,700, 150, false,1050,	CellPositions.SYDNEY),
//	NEW_YORK("NEW_YORK", "red", 22000000, 1500000, 1700000, 1900000, 150, 0,90, 250,700, 150, false, 1050,CellPositions.NEW_YORK),
//	LONDON("LONDON","red", 24000000, 1700000, 1900000,2100000, 150, 0,100, 300,750, 150,false, 1100,CellPositions.LONDON),
//	BEIJING("BEIJING", "yellow", 2600000, 2000000, 2000900, 2003100, 150, 0,110, 330,800, 150,false,1150,CellPositions.BEIJING), 
//	HONG_KONG("HONG_KONG", "yellow",2600000, 2000000, 2000070, 310, 150, 0,110, 330,800, 150, false,1150, CellPositions.HONG_KONG),
//	JERUSALEM("JERUSALEM", "yellow", 2800000, 2200000, 3000000, 340, 150, 0,120, 360,850, 150, false,1200,CellPositions.JERUSALEM), 
//	PARIS("PARIS", "green",3000000, 2600000, 2300000, 2700350, 200, 0,130, 390,900, 200, false, 1280,CellPositions.PARIS),
//	BELGRADE("BELGRADE","green", 3000000, 2600000, 2300000, 2700350, 200, 0,130, 390,900, 200, false,1280,	CellPositions.BELGRADE),
//	CAPE_TOWN("CAPE_TOWN", "green",3300000, 2700000, 2900300, 360, 200, 0,160, 450,1000, 200, false, 1300,CellPositions.CAPE_TOWN), 
//	RIGA("RIGA","blue", 3500000, 2900000, 3100000, 3100400, 200, 0,180,500, 1100,200,  false, 1500,CellPositions.RIGA),
//	MONTREAL("MONTREAL", "blue", 4000000, 2900000, 3100000, 3100400, 200, 0,200, 600,1400, 200, false,2000,CellPositions.MONTREAL);
