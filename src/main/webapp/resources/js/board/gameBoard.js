...
// function() {
	...
	/*
	 * stepOnBoard(player1); stepOnBoard(PLAYER_2);
	 * stepOnBoard(player3); stepOnBoard(player4);
	 */
	 ...
	 *
	 * var cellColor = function(Cell){ var t =
	 * $(Cell).css('backgroundColor'); }; /* /* var tt =
	 * cellColor(ownerCell); alert(tt);
	 */
	/*
	 * function(){ if(player==cellColor(ownerCell)){ alert("!"); }else
	 * if{ alert("1"); } };
	 */
	/*
	 ...
	 * if(player==cellColor(ownerCell)){ alert("It's you city!"); }else
	 * if((cellColor(Cell)==defaultColor){ alert("You can buy!"); }else{
	 * alert("Pay the tax!"); } }; changeOwner(player1, ownerCell);
	 */
